...
public:
	...
	typedef std::map<QString, std::vector<MathLib::Vector2>> ModelInfo;
	...
	void setInScenePlaneID(int id) { m_inScenePlaneID = id; };
	int getInScenePlaneID() { return m_inScenePlaneID; };
...
private:
	...
	int m_inScenePlaneID; // wll: In a scene, each support plane has a plane ID.  wll
